    ...
    if (table != null) {
        ...
        $(table.body()).on('click', 'td', function () {
            ...
            if ((settings.columns && settings.columns.indexOf(currentColumnIndex) > -1) || (!settings.columns)) {
                ...
                if ((row.data()['dealerCode'] != null && row.data()['dealerCode'] != 'undefined' && row.data()['dealerCode'] != 'Toplam') || (row.data()['customerName'] != null && row.data()['customerName'] != 'undefined' && row.data()['customerName'] != 'Toplam' && (row.data()['isSubmit'] == false || row.data()['isEditable'] == true))) {
                    ...
                    // Show input
                    if ((!$(cell).find('input').length || $(cell).find('input').val() == '') && !$(cell).find('select').length && !$(cell).find('textarea').length) {
                        // Input CSS
                        var input = getInputHtml(currentColumnIndex, settings, oldValue.toString().replace(".", ","));
...
function getInputHtml(currentColumnIndex, settings, oldValue) {
    ...
    switch (inputType) {
        ...
        case "list-confirm": // List w/ confirm
            ...
            input.html = input.html + "</select>&nbsp;<a href='javascript:void(0);' class='" + confirmCss + "' onclick='$(this).updateEditableCell(this);'>Onayla</a> <a href='javascript:void(0);' class='" + cancelCss + "' onclick='$(this).cancelEditableCell(this)'>Reddet</a>" + endWrapperHtml;
            input.focus = false;
            break;
        ...
        case "datepicker-confirm":
            ...
            input.html = startWrapperHtml + "<input id='ejbeatycelledit' type='text' name='date' class='datepick " + inputCss + "'   value='" + oldValue + "'></input> &nbsp;<a href='javascript:void(0);' class='" + confirmCss + "' onclick='$(this).updateEditableCell(this)'>Onayla</a> <a href='javascript:void(0);' class='" + cancelCss + "' onclick='$(this).cancelEditableCell(this)'>Reddet</a>" + endWrapperHtml;
        ...
        case "textarea-confirm":
            input.html = startWrapperHtml + "<textarea id='ejbeatycelledit' class='" + inputCss + "'>" + oldValue + "</textarea><a href='javascript:void(0);' class='" + confirmCss + "' onclick='$(this).updateEditableCell(this)'>Onayla</a> <a href='javascript:void(0);' class='" + cancelCss + "' onclick='$(this).cancelEditableCell(this)'>Reddet</a>" + endWrapperHtml;
            break;
        case "number-confirm":
